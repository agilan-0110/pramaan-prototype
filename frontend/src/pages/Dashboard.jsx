...
/**
 * Returns HTML string for vanilla layout shell embedding.
 */
  ...
  return (
    <div className="setu-dashboard">
      ...
      <div className="setu-page-header">
        ...
        <p className="setu-page-desc">National Monitoring & Risk Engine Overview</p>
      </div>
      ...
      <div className="setu-table-card">
        <div className="setu-table-card-header">
          <div>
            <h2 className="setu-table-title">Audited Projects</h2>
